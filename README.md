# Plataforma Web de Gestión de Viajes y Alquiler - Interfaces de Usuario

Proyecto grupal de desarrollo frontend para la asignatura de **Creación y Programación de Interfaces Web (UC3M)**.
...
* **Búsqueda y Filtros:** Filtrado dinámico de experiencias y vehículos disponibles.
* **Validación W3C:** Cumplimiento de estándares de calidad HTML5 y CSS3 en todas las páginas.
